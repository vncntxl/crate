...
12. [12-styling.md](12-styling.md) — the CSS approach (variables, responsive layout)

**The golden rule of the viva:** for any line of code, you should be able
to answer three questions — *what does this do*, *why does it exist*, and
*what would break if it weren't here*. These docs are written to answer
all three for every file in the project.
